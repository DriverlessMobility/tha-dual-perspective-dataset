...
python ./tools/dist_test.py ./configs/waymo_centerpoint_pp_two_pfn_stride1_3x_av.py --checkpoint /workspace/work_dir/WaymoTraining/latest.pth --work_dir /workspace/work_dir/AV_Test
python ./tools/dist_test.py ./configs/waymo_centerpoint_pp_two_pfn_stride1_3x_its.py --checkpoint /workspace/work_dir/WaymoTraining/latest.pth --work_dir /workspace/work_dir/ITS_Test
python ./tools/dist_test.py ./configs/waymo_centerpoint_pp_two_pfn_stride1_3x_its.py --checkpoint /workspace/work_dir/its_finetuning/latest.pth --work_dir /workspace/work_dir/ITS_finetuned_Test

bash ./ComputeMetricsOnly.sh
